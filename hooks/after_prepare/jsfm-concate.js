...
var counter = 0;
 ...
 var command = "jsx -x  jsx "+ path.join(platformPath, "html")+ " " + path.join(platformPath, "js","react");
 exec(command,function(a,b){console.log(a,b)});

function jsManage() {
	foldersToProcess.forEach(function(folder) {
		var configdir = path.join(platformPath, folder, "com/app/Config.js");
